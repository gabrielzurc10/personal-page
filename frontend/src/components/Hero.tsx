...
export default function Hero() {
  return (
    <section className="flex min-h-screen items-center justify-center px-6 pt-16">
      <GradientReveal className="card-hover mx-auto flex max-w-6xl flex-col items-center gap-8 rounded-2xl bg-white p-8 dark:bg-white/[0.02] sm:gap-12 sm:p-12 md:flex-row md:gap-16">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="mb-8 max-w-xl text-lg leading-relaxed text-neutral-500 dark:text-neutral-400">
            Software Engineer with 4+ years of experience developing 
            scalable cloud-native applications and automation workflows. 
            Shipped enterprise-scale software across HR/payroll, 
            telecommunications, and higher education organizations, 
          ...
          <div className="flex flex-wrap justify-center gap-4 md:justify-start">
            ...
            <a
              ...
              className="border-gradient-hover inline-flex items-center rounded-full bg-neutral-100 px-6 py-3 text-sm font-medium text-neutral-700 dark:bg-white/10 dark:text-neutral-300"
            >
